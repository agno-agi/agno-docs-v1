...
Looking for a self-hosted alternative? Check out our Open Source [Agent UI](https://github.com/agno-ai/agent-ui) - a modern chat interface built with Next.js and TypeScript that works with the Agno Playground backend.
...
The UI will connect to `localhost:7777` by default, matching the Playground setup above. Visit [GitHub](https://github.com/agno-ai/agno-ui) for more details.
