...
Looking for a self-hosted alternative? Check out our Open Source [Agent UI](https://github.com/agno-ai/agno-ui) - a modern chat interface built with Next.js and TypeScript that works with the Agno Playground backend.
