...
- Setting up a GitHub MCP server in the Playground
- Using SQLite storage for conversation history
- Configuring agent parameters for optimal interaction

Here are some example prompts you can try with the GitHub agent:
