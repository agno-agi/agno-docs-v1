...
The following agent will use Browserbase to visit a quotes website and extract content. Then navigate to page two of its website and get quotes from there as well.
