...
| ------------------ | -------------------------------- | ------- | ------------------------------------------------ |
| `connection`       | `psycopg2.extensions.connection` | -  | Optional database connection object.             |
...
| `host`             | `str`                            | -  | Optional host for the database connection.       |
| `port`             | `int`                            | -  | Optional port for the database connection.       |
