...
| -------------- | ----- | ------- | ----------------------------------------------------------------------- |
| `username`     | `str` | `None`       | The username used for authentication or identification purposes.        |
| `password`     | `str` | `None`       | The password associated with the username for authentication purposes.  |
| `company_name` | `str` | `None`       | The name of the company related to the user or the data being accessed. |
