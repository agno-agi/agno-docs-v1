...
| ------------------- | ----- | ------- | --------------------------------------------------- |
| `fixed_max_results` | `int` | -  | Optional fixed maximum number of results to return. |
| `fixed_language`    | `str` | -  | Optional fixed language for the requests.           |
| `headers`           | `Any` | -  | Optional headers to include in the requests.        |
| `proxy`             | `str` | -  | Optional proxy to be used for the requests.         |
