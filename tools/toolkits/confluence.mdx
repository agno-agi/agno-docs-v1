...
| --------- | -------- | ------- | ------------------------------------------------------------------------------------------------------------------------------ |
| `username`| `str`    | `None`  | Confluence username. Can also be set via environment variable CONFLUENCE_USERNAME.                                           |
| `password`| `str`    | `None`  | Confluence password or API key. Can also be set via environment variables CONFLUENCE_API_KEY or CONFLUENCE_PASSWORD.       |
| `url`     | `str`    | `None`  | Confluence instance URL. Can also be set via environment variable CONFLUENCE_URL.                                            |
| `api_key` | `str`    | `None`  | Confluence API key (alternative to password).                                                                                 |
