...
| `consumer_key`        | `str` | -  | The consumer key for Twitter API authentication        |
| `consumer_secret`     | `str` | -  | The consumer secret for Twitter API authentication     |
| `access_token`        | `str` | -  | The access token for Twitter API authentication        |
| `access_token_secret` | `str` | -  | The access token secret for Twitter API authentication |
