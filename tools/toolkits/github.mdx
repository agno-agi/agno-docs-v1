...
| -------------------------- | ------ | ------- | ----------------------------------------------------------------------------------------------------------- |
| `access_token`             | `str`  | -  | Github access token for authentication. If not provided, will use GITHUB_ACCESS_TOKEN environment variable. |
| `base_url`                 | `str`  | -  | Optional base URL for Github Enterprise installations.                                                      |
