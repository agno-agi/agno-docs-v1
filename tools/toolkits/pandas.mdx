...
| `create_pandas_dataframe` | `function`                | `None`       | Registers a function to create a Pandas DataFrame.             |
| `run_dataframe_operation` | `function`                | `None`       | Registers a function to run operations on a Pandas DataFrame.  |
