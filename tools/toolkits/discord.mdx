...
**DiscordTools** enable and agent to send messages, read message history, manage channels, and delete messages in Discord.

## Prerequisites

The following example requires a valid Discord bot token. You can set the `DISCORD_BOT_TOKEN` environment variable or pass it to the `DiscordTools` constructor.
