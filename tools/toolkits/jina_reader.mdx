...
| `base_url`           | `str` | `None`       | The base URL of the API, retrieved from the configuration.                 |
| `search_url`         | `str` | `None`       | The URL used for search queries, retrieved from the configuration.         |
| `max_content_length` | `int` | `None`       | The maximum length of content allowed, retrieved from the configuration.   |
