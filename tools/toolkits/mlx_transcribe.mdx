...
| `temperature`                     | `float` or `Tuple[float, ...]` | -                                   | Temperature for sampling                    |
...
| `clip_timestamps`                 | `str` or `List[float]`         | -                                   | Clip timestamps                             |
| `hallucination_silence_threshold` | `float`                        | -                                   | Hallucination silence threshold             |
| `decode_options`                  | `dict`                         | -                                   | Additional decoding options                 |
