...
4. **Download sample audio** (optional)
   - Visit the [TED talk on AI and Human Creativity](https://www.ted.com/talks/reid_hoffman_and_kevin_scott_the_evolution_of_ai_and_how_it_will_impact_human_creativity) (as an example) and save the audio file to the `storage/audio` directory.
