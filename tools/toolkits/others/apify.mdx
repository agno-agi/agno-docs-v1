...
agent.print_response("What information can you find on https://docs-v1.agno.com/introduction ?", markdown=True)
```
...
agent.print_response("Summarize the content from https://docs-v1.agno.com/introduction", markdown=True)
```
