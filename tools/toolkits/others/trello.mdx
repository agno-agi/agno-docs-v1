---
title: Trello
description: Learn how to use Agno TrelloTools to integrate Trello functionalities into your agents, enabling management of boards, lists, and cards.
---

**TrelloTools** enable an Agent to interact with Trello, allowing it to manage boards, lists, and cards.
...
- View [Tools Source](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/trello.py) (assuming file path)
- View [Cookbook Example](https://github.com/agno-agi/agno/blob/main/cookbook/tools/trello_tools.py) (assuming file path)
