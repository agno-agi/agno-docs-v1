...
thinking_agent.print_response(
    ...
    "What key considerations should we take into account, and what steps should we follow?",
    stream=True
)
```
...
thinking_agent.print_response(
    ...
    "and potential risks before launch. Help us think through the key issues.",
    stream=True,
)
```
