...
- **Support for MCP**: Introducing `MCPTools` and examples for using MCP with Agno agents.

## Bug Fixes:

- **Mistral with reasoning**: Fixed cases where Mistral would fail if there were reasoning models from other providers that produced reasoning content.
