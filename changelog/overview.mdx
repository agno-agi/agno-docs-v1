...
- On the `Agent` class, `guidelines`, `prevent_hallucinations`, and `task` has been removed. They can be incorporated into the `instructions` parameter as you see fit.
