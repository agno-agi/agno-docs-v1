...
playground = Playground(agents=[agno_support, agno_support_voice], app_id="agno_assist", name="Agno Assist", description="Agno Assist")
...
if __name__ == "__main__":
    ...
    playground.serve("agno_assist:app", reload=True)
