...
playground = Playground(agents=[web_agent, finance_agent, youtube_agent], app_id="ollama_agents_app", name="Ollama Agents App", description="Ollama Agents App")

app = playground.get_app()


if __name__ == "__main__":
    playground.serve("ollama_agents:app", reload=True)
