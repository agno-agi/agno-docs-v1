...
playground = Playground(agents=[audio_and_text_agent], app_id="audio_conversation_app", name="Audio Conversation App", description="Audio Conversation App")

app = playground.get_app()

if __name__ == "__main__":
    playground.serve("audio_conversation_agent:app", reload=True)
