...
<Step title="Set your AWS credentials">
  ```bash export AWS_ACCESS_KEY_ID=xxx export AWS_SECRET_ACCESS_KEY=xxx export OPENAI_API_KEY=xxx
  ```
</Step>

{' '}

<Step title="Install libraries">```bash pip install -U boto3 openai agno ```</Step>
