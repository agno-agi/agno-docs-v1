...
<Step title="Set your API key">```bash export GIPHY_API_KEY=xxx export OPENAI_API_KEY=xxx ```</Step>

{' '}

<Step title="Install libraries">```bash pip install -U giphy_client openai agno ```</Step>
