...
<Step title="Set your API key">```bash export OPENAI_API_KEY=xxx export FAL_KEY=xxx ```</Step>

{' '}

<Step title="Install libraries">```bash pip install -U openai fal agno ```</Step>
