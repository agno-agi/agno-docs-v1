...
app = Playground(agents=[rag_agent], app_id="agentic_rag_agent_app", name="Agentic RAG Agent App", description="Agentic RAG Agent App").get_app()

if __name__ == "__main__":
    # Load the knowledge base: Comment after first run as the knowledge base is already loaded
    knowledge_base.load(upsert=True)

    app.serve("agentic_rag_agent_ui:app", reload=True)
```
