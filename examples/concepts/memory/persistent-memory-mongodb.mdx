...
<Step title="Install libraries">```bash pip install -U openai pymongo agno ```</Step>

{' '}

<Step title="Run MongoDB">Make sure you have MongoDB running locally on port 27017</Step>
