...
<Step title="Install libraries">```bash pip install agno ```</Step>

{' '}

<Step title="Set environment variables">```bash export DISCORD_BOT_TOKEN=**** ```</Step>

{' '}

<Step title="Run the agent">```bash python discord_agent.py ```</Step>
