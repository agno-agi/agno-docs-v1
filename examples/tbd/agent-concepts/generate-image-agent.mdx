...
<Step title="Install libraries">```bash pip install openai agno ```</Step>

{' '}

<Step title="Run the agent">```bash python generate_image_agent.py ```</Step>

{' '}

<Step title="View the image">Open the image URL in your browser to view the image.</Step>
