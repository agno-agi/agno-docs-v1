...
<Step title="Install libraries">```bash pip install openai exa_py agno ```</Step>

{' '}

<Step title="Set environment variables">
  ```bash export OPENAI_API_KEY=**** export EXA_API_KEY=**** ```
</Step>

{' '}

<Step title="Run the agent">```bash python movie_recommender.py ```</Step>
