...
<video autoPlay muted controls className="aspect-video w-full" src="/videos/chess-team.mp4"></video>
...
<Step title="Install Dependencies">
  ```bash pip install -r cookbook/examples/apps/chess_team/requirements.txt ```
</Step>
...
<Step title="Launch the App">
  ```bash streamlit run cookbook/examples/apps/chess_team/app.py ```
</Step>
