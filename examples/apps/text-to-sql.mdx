...
<video autoPlay muted controls className="aspect-video w-full" src="/videos/sql_agent.mp4"></video>
...
<Step title="Install dependencies">
  ```bash pip install -r cookbook/examples/apps/sql_agent/requirements.txt ```
</Step>
...
<Step title="Load F1 data">
  ```bash python cookbook/examples/apps/sql_agent/load_f1_data.py ```
</Step>
