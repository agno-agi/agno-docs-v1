...
<video autoPlay muted controls className="aspect-video w-full" src="/videos/geobuddy.mp4"></video>
...
<Step title="Install Dependencies">
  ```bash pip install -r cookbook/examples/apps/geobuddy/requirements.txt ```
</Step>
...
<Step title="Launch the App">```bash streamlit run cookbook/examples/apps/geobuddy/app.py ```</Step>
