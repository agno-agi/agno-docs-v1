...
### Advanced Usage
Try providing images with subtle details—like store signs in different languages or iconic but less globally famous landmarks. GeoBuddy will attempt to reason more deeply about architecture style, environment (e.g., desert vs. tropical), and cultural references.
