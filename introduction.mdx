---
title: Introduction
description: "Superintelligence: a network of agents, multi-agent teams and agentic workflows with shared memory, knowledge, and reasoning, operating as a single unit."
---
...
2. **Agents with memory and knowledge:** Agents that dynamically access memory and knowledge at runtime, improving performance and response quality.
...
Agent OS is a system of agents, teams and workflows, operating as a single unit. Agno helps you build the Agent OS and provides a beautiful UI to run, monitor and manage it.
