...
- **User:** A user represents an individual entity that interacts with the Agent. Each user has specific session state, memories, summaries, and conversation history separate from other users.
