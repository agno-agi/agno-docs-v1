...
<Tip>
Some models, like `llama-3.2-11b-vision-preview`, require that there be no system message. In such cases, you can set `create_default_system_message=False` and `system_message=None` to disable system messages.
</Tip>
