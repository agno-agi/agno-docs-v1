...
You can enable streaming of intermediate steps by setting `stream_intermediate_steps=True`. This will provide detailed information about the agent's execution process through various events:
...
When streaming intermediate steps, you'll receive the following events:

| Event Type | Description |
|------------|-------------|
| `RunStarted` | Indicates the start of a run |
| `RunResponse` | Contains the model's response |
...
| `ToolCallCompleted` | Signals completion of a tool call |
