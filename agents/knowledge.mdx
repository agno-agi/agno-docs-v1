...
|-----------|------|---------|-------------|
| `knowledge` | `AgentKnowledge` | - | Provides the knowledge base used by the agent. |
...
| `retriever` | `Callable[..., Optional[list[dict]]]` | - | Function to get context to add to the user message. This function is called when add_references is True. |
