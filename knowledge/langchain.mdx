...
| --------------- | -------------------- | ------- | ------------------------------------------------------------------------- |
| `loader`        | `Optional[Callable]` | -  | LangChain loader.                                                         |
| `vectorstore`   | `Optional[Any]`      | -  | LangChain vector store used to create a retriever.                        |
| `search_kwargs` | `Optional[dict]`     | -  | Search kwargs when creating a retriever using the langchain vector store. |
| `retriever`     | `Optional[Any]`      | -  | LangChain retriever.                                                      |
