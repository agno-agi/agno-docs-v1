...
OpenAI has bunch of world class models. See the library [here](https://platform.openai.com/docs/models).

We recommend experimenting to find the best-suited model for your use-case. Here are some general recommendations:

- `gpt-4o` models are good for most of the regular use-cases.
- `gpt-4o-mini` models are good for smaller tasks and faster inference.
- `o1` and `o1-mini` models are good for complex reasoning and multi-step tasks.
