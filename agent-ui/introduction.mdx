...
playground = Playground(agents=[web_agent, finance_agent], app_id="playground-app", name="Playground App", description="A playground for agents")
...
<Tip>Make sure the `playground.serve()` method points to the correct module and app instance (e.g., `"playground:app"`).</Tip>
