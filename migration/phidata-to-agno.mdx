...
- All `phi` namespaces are now replaced with `agno` to reflect the updated branding and structure.
...
Follow the steps above to ensure your codebase is compatible with the latest version of Agno AI. If you encounter any issues, refer to the updated documentation for further guidance.
