...
Agno Playground gives a robust interface to test your agentic systems.

- **Streaming Support**: Real-time response streaming and intermediate states back to the user.

- **Storage**: Visualize conversation history right in the playground. [<Icon icon="arrow-up-right-from-square" size={14} />](/storage/introduction)

- **Memory**: Visualize user details and preferences across conversations. [<Icon icon="arrow-up-right-from-square" size={14} />](/memory/introduction)
...
- **Reasoning Support**: Built-in support for detailed reasoning traces displayed in the playground interface. [<Icon icon="arrow-up-right-from-square" size={14} />](/reasoning/introduction)

- **Human in Loop Support**: Enable manual intervention in agent workflows with specialized human oversight and approval. [<Icon icon="arrow-up-right-from-square" size={14} />](/tools/hitl#human-in-the-loop)

- **Multimodal Support**: Support for processing and generating text, images, audio, and other media types. [<Icon icon="arrow-up-right-from-square" size={14} />](/agents/multimodal)

- **Multi-Agent Systems**: Support for multi-agent teams and workflows. [<Icon icon="arrow-up-right-from-square" size={14} />](/teams/introduction)
