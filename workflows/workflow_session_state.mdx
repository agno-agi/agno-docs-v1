---
title: How does shared context work between workflows, teams and agents?
sidebarTitle: Workflow Session State
description: Learn to handle shared context between the different components of a Workflow
---

## Overview
The workflow session state is a powerful feature of the Workflow system that allows for the persistence and sharing of state information across different components of a workflow. This state is crucial for maintaining context and continuity in workflows that involve multiple tasks, agents, and teams.
