...
| `supports_native_structured_outputs` | `bool`                     | `True`               | Whether the model natively supports structured outputs.                               |
...
| `client`                      | `Optional[OpenAI]`                | `None`               | The OpenAI client instance.                                                           |
| `async_client`                | `Optional[AsyncOpenAI]`           | `None`               | The asynchronous OpenAI client instance.                                              |
