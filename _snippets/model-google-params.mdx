...
| `vertex_ai_search`        | `bool`                                | `False`                  | Whether to use Vertex AI Search for private knowledge base grounding. |
| `vertex_ai_search_datastore` | `Optional[str]`                    | `None`                   | The Vertex AI Search datastore ID for private knowledge base search. |
